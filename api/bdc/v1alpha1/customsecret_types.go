...
// SetConditions set condition for CustomSecret
func (cd *CustomSecret) SetConditions(c ...condition.Condition) {
	cd.Status.SetConditions(c...)
}

// GetCondition gets condition from CustomSecret
func (cd *CustomSecret) GetCondition(conditionType condition.ConditionType) condition.Condition {
