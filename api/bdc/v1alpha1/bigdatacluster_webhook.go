...
//+kubebuilder:webhook:path=/mutate-bdc-bdos-io-v1alpha1-bigdatacluster,mutating=true,failurePolicy=fail,sideEffects=None,groups=bdc.bdos.io,resources=bigdataclusters,verbs=create;update,versions=v1alpha1,name=mbigdatacluster.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-bdc-bdos-io-v1alpha1-bigdatacluster,mutating=false,failurePolicy=fail,sideEffects=None,groups=bdc.bdos.io,resources=bigdataclusters,verbs=create;update,versions=v1alpha1,name=vbigdatacluster.kb.io,admissionReviewVersions=v1
