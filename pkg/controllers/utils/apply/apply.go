...
// excludeLastAppliedConfigurationForSpecialResources will filter special object that can reduce the record for "bdc.bdos.io/last-applied-configuration" annotation.
