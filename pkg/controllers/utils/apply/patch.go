...
func addLastAppliedConfigAnnotation(obj runtime.Object) error {
	...
	annots[constants.AnnotationLastAppliedConfig] = string(config)
...
func getModifiedConfiguration(obj runtime.Object, updateAnnotation bool) ([]byte, error) {
	...
	original := annots[constants.AnnotationLastAppliedConfig]
	// remove the annotation to avoid recursion
	delete(annots, constants.AnnotationLastAppliedConfig)
	...
	if updateAnnotation {
		annots[constants.AnnotationLastAppliedConfig] = string(modified)
	...
	annots[constants.AnnotationLastAppliedConfig] = original
	_ = metadataAccessor.SetAnnotations(obj, annots)
	return modified, nil
}
...
func getOriginalConfiguration(obj runtime.Object) ([]byte, error) {
	...
	original, ok := annots[constants.AnnotationLastAppliedConfig]
	if !ok {
		return nil, nil
	}
