...
import (
	...
	context2 "bpaas-core-operator/pkg/controllers/bdc/defcontext"
	cueutil "bpaas-core-operator/pkg/cue"
	"context"
	"cuelang.org/go/cue"
...
type AbstractEngine interface {
	RenderCUETemplate(ctx context2.ContextData, abstractTemplate string, params interface{}) ([]*unstructured.Unstructured, error)
...
func (wd *BigDataClusterDef) HealthCheck(templateContext map[string]interface{}, healthPolicyTemplate string, parameter interface{}) (bool, error) {
	//TODO implement me
	panic("implement me")
}

func (wd *BigDataClusterDef) Status(templateContext map[string]interface{}, customStatusTemplate string, parameter interface{}) (string, error) {
	//TODO implement me
	panic("implement me")
}

func (wd *BigDataClusterDef) RenderCUETemplate(ctx context2.ContextData, abstractTemplate string, params interface{}) ([]*unstructured.Unstructured, error) {
