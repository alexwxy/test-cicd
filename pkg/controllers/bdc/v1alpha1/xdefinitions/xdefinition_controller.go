...
import (
	...
	"bpaas-core-operator/pkg/controllers/bdc/deftemplate"
...
//+kubebuilder:rbac:groups=bdc.bdos.io,resources=xdefinitions,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=bdc.bdos.io,resources=xdefinitions/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=bdc.bdos.io,resources=xdefinitions/finalizers,verbs=update
...
func (r *Reconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	//apiResourceDefMap[xDefinition.Spec.APIResource.Definition.Kind] = string(utils.MustJSONMarshal(map1))

	var cmName string
	cmName, err = CreateOrUpdateConfigMap(ctx, r.Client, apiResourceDefMap)
	if err != nil {
		return ctrl.Result{}, nil
	}
	klog.InfoS("", "", cmName)
...
func CreateOrUpdateConfigMap(ctx context.Context, k8sClient client.Client, data map[string]string) (string, error) {
