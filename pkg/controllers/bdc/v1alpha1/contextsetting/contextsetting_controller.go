...
//+kubebuilder:rbac:groups=bdc.bdos.io,resources=contextsettings,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=bdc.bdos.io,resources=contextsettings/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=bdc.bdos.io,resources=contextsettings/finalizers,verbs=update
