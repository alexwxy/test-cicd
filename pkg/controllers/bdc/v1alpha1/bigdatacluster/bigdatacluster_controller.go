...
//+kubebuilder:rbac:groups=bdc.bdos.io,resources=bigdataclusters,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=bdc.bdos.io,resources=bigdataclusters/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=bdc.bdos.io,resources=bigdataclusters/finalizers,verbs=update
...
func (r *Reconciler) handleFinalizers(ctx context.Context, bigDataCluster *bdcv1alpha1.BigDataCluster, bdcFile *parser.BDCFile) (bool, ctrl.Result, error) {
	...
	myFinalizerName := "ns.bdc.bdos.io/finalizer"
