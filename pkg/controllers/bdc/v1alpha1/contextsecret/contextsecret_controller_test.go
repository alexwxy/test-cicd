...
var _ = Describe("Test ContextSecret Controller", func() {
	...
	BeforeEach(func() {
		var validDef = utils.ReadContent(filepath.Join("../../../../..", "charts", "bpaas-core-operator", "templates", "deftemplate", "contextsecret-def.yaml"))
		// Create namespace
...
metadata:
  ...
  annotations:
    ...
    "bdc.bdos.io/name": "bdc-sample1"
    "secret.ctx.bdc.bdos.io/type": "HDFS/KDC/..."
    "secret.ctx.bdc.bdos.io/origin": "system/manual"
spec:
