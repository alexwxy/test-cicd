...
//+kubebuilder:rbac:groups=bdc.bdos.io,resources=contextsecrets,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=bdc.bdos.io,resources=contextsecrets/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=bdc.bdos.io,resources=contextsecrets/finalizers,verbs=update
