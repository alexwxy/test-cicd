...
import (
	bigdatacluster "bpaas-core-operator/api/bdc/v1alpha1"
	"context"
	"fmt"
	"net/http"
...
func RegisterValidatingHandler(mgr manager.Manager) {
	...
	server.Register("/validate-bdc-bdos-io-v1alpha1-bigdatacluster", &webhook.Admission{Handler: &ValidatingHandler{}})
}
